...
(function () {
  var SYNC_TOOLS = ["mood", "thoughts", "gratitude", "habits", "sleep", "worries", "copingcards", "achievements", "compassionbreak", "fears", "values", "ficha", "scores", "test_results"];
  var SHARE_CATEGORIES = ["test_results", "mood", "thoughts", "gratitude", "habits", "sleep", "worries", "copingcards", "achievements", "compassionbreak", "fears", "values", "scores"];
