...
- **10 psychological tests**: Big Five personality, Attachment style, Emotional Intelligence, Perceived Stress, Rosenberg Self-Esteem, Resilience, PANAS (positive/negative affect), Self-Compassion, Assertiveness, Dispositional Gratitude.
- **13 tools**: mood diary, thought record (CBT), breathing exercise, guided meditation, gratitude journal, habit tracker, sleep diary, worry box, progressive muscle relaxation, coping cards, achievement log, a guided self-compassion break, and a patterns/insights panel that surfaces trends across your own logged data.
- **13 games**: Stroop test, reaction time, emotion recognition, cognitive bias quiz, prisoner's dilemma, choose-your-path adventure, digit span, myth-or-fact quiz, N-back, a cognitive-distortion spotting game, a wheel-of-emotions vocabulary game, an inner-critic reframing game, and an assertive-communication scenario game.
